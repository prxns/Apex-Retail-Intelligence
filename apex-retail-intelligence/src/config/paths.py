"""Portable filesystem locations for local Spark and Databricks runs.

Set APEX_RETAIL_SOURCE_ROOT and APEX_RETAIL_DATA_ROOT in Databricks when the
supplied data and managed storage live in different volumes.
"""
import os
